'''
add shift to the left and to the right then delet this comment. v3 of this program.
'''
...
def hex_r_shift():
    hex1 = int(input(TerminalColors.BRIGHT_WHITE + '\nEnter a hex number: ' + TerminalColors.BRIGHT_GREEN), 16)  
    shift_num = int(input(TerminalColors.BRIGHT_WHITE + 'Enter the shift amount(1, 2, 3, ...): ' + TerminalColors.BRIGHT_GREEN))  
    hex_result = hex(hex1 >> shift_num)
    print(TerminalColors.BRIGHT_WHITE + f"\n{hex(hex1)} shifted to the right by {shift_num} is: {hex_result}")

def hex_l_shift():
    hex1 = int(input(TerminalColors.BRIGHT_WHITE + '\nEnter a hex number: ' + TerminalColors.BRIGHT_GREEN), 16)  
    shift_num = int(input(TerminalColors.BRIGHT_WHITE + 'Enter the shift amount(1, 2, 3, ...): ' + TerminalColors.BRIGHT_GREEN))  
    hex_result = hex(hex1 << shift_num)
    print(TerminalColors.BRIGHT_WHITE + f"\n{hex(hex1)} shifted to the left by {shift_num} is: {hex_result}")

def binary_r_shift():
    bin1 = int(input(TerminalColors.BRIGHT_WHITE + '\nEnter a binary number: ' + TerminalColors.BRIGHT_GREEN), 2)  
    shift_num = int(input(TerminalColors.BRIGHT_WHITE + 'Enter the shift amount(1, 2, 3,...): ' + TerminalColors.BRIGHT_GREEN))  
    bin_result = bin(bin1 >> shift_num)
    print(TerminalColors.BRIGHT_WHITE + f"\n{(bin1)} shifted to the right by {shift_num} is: {bin_result}")

def binary_l_shift():
    bin1 = int(input(TerminalColors.BRIGHT_WHITE + '\nEnter a binary number: ' + TerminalColors.BRIGHT_GREEN), 2)  
    shift_num = int(input(TerminalColors.BRIGHT_WHITE + 'Enter the shift amount(1, 2, 3,...): ' + TerminalColors.BRIGHT_GREEN))  
    bin_result = bin(bin1 << shift_num)
    print(TerminalColors.BRIGHT_WHITE + f"\n{(bin1)} shifted to the left by {shift_num} is: {bin_result}")

def shift_menu(): # add the function for the shift
    while(True): 
        print(TerminalColors.BRIGHT_YELLOW + '1)' + TerminalColors.BRIGHT_MAGENTA + ' Hexadecimal right shift\n' + TerminalColors.BRIGHT_YELLOW + '2)' + TerminalColors.BRIGHT_MAGENTA + ' Hexadecimal left shift\n' + TerminalColors.BRIGHT_YELLOW + '3)' + TerminalColors.BRIGHT_MAGENTA + ' Binary right shift\n' + TerminalColors.BRIGHT_YELLOW + '4)' + TerminalColors.BRIGHT_MAGENTA + ' Binary left shift\n'  + TerminalColors.BRIGHT_YELLOW + '0)' + TerminalColors.BRIGHT_RED + ' Go Back to The Main Menu\n' + TerminalColors.RESET)
        try:
            user_input4 = int(input(TerminalColors.BRIGHT_CYAN +'Enter option:' + TerminalColors.BRIGHT_YELLOW + ' 1,2,3,4 or 0: '+ TerminalColors.BRIGHT_GREEN))
            ...
            match(user_input4):
                ...
                case 4:
                    binary_l_shift()
                case _:            
                    print(TerminalColors.BRIGHT_RED +'\n-------', user_input4,'Is not a valid option-------\n') 
            print(TerminalColors.BRIGHT_CYAN + '\n-------Bit shift Menu-------\n')                        
        except Exception:
            print(TerminalColors.BRIGHT_RED +'\n-------not a valid option-------\n') 
            print(TerminalColors.BRIGHT_CYAN + '\n-------Bit shift Menu-------\n')
